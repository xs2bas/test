...
function Controller() {
    ...
    function _updateMessage(_message) {
        _message ? $.isText.text = _message : 0 === currentState || false === currentState ? $.isText.text = options.msgError : -1 === currentState ? $.isText.text = options.msgDone : $.isText.text = options.msgTap;
    }
    function hide() {
        $.is.hide();
    }
