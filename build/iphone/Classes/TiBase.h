...
// in simulator we redefine to format for Huurders Developer console
...
{\
	NSString * exceptionName = [@"org.huurders." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.huurders";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIHuurdersNativeItemNone = -1, 
	UIHuurdersNativeItemSpinner = -2,
	UIHuurdersNativeItemProgressBar = -3,
	
	UIHuurdersNativeItemSlider = -4,
	UIHuurdersNativeItemSwitch = -5,
	UIHuurdersNativeItemMultiButton = -6,
	UIHuurdersNativeItemSegmented = -7,
	
	UIHuurdersNativeItemTextView = -8,
	UIHuurdersNativeItemTextField = -9,
	UIHuurdersNativeItemSearchBar = -10,
	
	UIHuurdersNativeItemPicker = -11,
	UIHuurdersNativeItemDatePicker = -12,
	
	UIHuurdersNativeItemInfoLight = -13,
	UIHuurdersNativeItemInfoDark = -14,
	
	UIHuurdersNativeItemDisclosure = -15,
	
	UIHuurdersNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all Huurders instances of
