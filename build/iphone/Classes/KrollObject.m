...
//@interface HuurdersObject : NSObject
//@end

@interface HuurdersObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[HuurdersObject class]])
		{
			for (NSString *key in [[(HuurdersObject*)o modules] allKeys])
			{
